...
{
	/// <summary>
	/// Override metadata for CoreDimensionsOverride
	/// </summary>
	public partial class CoreDimensionsOverride : IOverride
	{
        public static string Name = "Core Dimensions";
        public static string Dependency = null;
        public static string Context = "[*discriminator=Elements.ServiceCore&BoundaryIsUnedited=true]";
	...
	public static class CoreDimensionsOverrideExtensions
    {
		/// <summary>
        /// Apply Core Dimensions edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Core Dimensions Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<CoreDimensionsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, CoreDimensionsIdentity, bool> identityMatch,
            Func<T, CoreDimensionsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Core Dimensions Overrides to apply — typically `input.Overrides.CoreDimensions`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<CoreDimensionsOverride> overrideData,
            Func<T, CoreDimensionsIdentity, bool> identityMatch,
            Func<T, CoreDimensionsOverride, T> modifyElement
            ) where T : Element
        {
