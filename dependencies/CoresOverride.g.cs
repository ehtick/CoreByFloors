...
{
	/// <summary>
	/// Override metadata for CoresOverride
	/// </summary>
	public partial class CoresOverride : IOverride
	{
        public static string Name = "Cores";
	...
	public static class CoresOverrideExtensions
    {
		/// <summary>
        /// Apply Cores edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Cores Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<CoresOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, CoresIdentity, bool> identityMatch,
            Func<T, CoresOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Cores Overrides to apply — typically `input.Overrides.Cores`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<CoresOverride> overrideData,
            Func<T, CoresIdentity, bool> identityMatch,
            Func<T, CoresOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Cores)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Cores)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Cores)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<CoresOverride> edits,
            IList<CoresOverrideAddition> additions,
            IList<CoresOverrideRemoval> removals,            Func<CoresOverrideAddition, T> createElement,
            Func<T, CoresIdentity, bool> identityMatch,
            Func<T, CoresOverride, T> modifyElement,
