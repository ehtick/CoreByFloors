...
namespace CoreByFloors
{
    public class Function
    {
        ...
        private IModelStore<CoreByFloorsInputs> store;

        public async Task<CoreByFloorsOutputs> Handler(CoreByFloorsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<CoreByFloorsInputs>(RegionEndpoint.USWest1);
            }
